...
// Globe container
const globeContainer = document.getElementById('globeDiv');
      ...
      ({ properties: d, covid: c }) => `
            <div class="card">
              ...
              <div class="container">
                 ...
                 <span class="card-total-cases">Total Cases: ${c.cases}</span>
                 <div class="card-spacer"></div>
                 <hr />
                 <div class="card-spacer"></div>
                 <span class="infected"> Infected: ${c.active}</span> <br />
                 <span class="deaths"> Deaths: ${c.deaths}</span> <br />
                 <span class="recovered"> Recovered: ${c.recovered}</span>
                 <div class="card-spacer"></div>
                 <hr />
                 <div class="card-spacer"></div>
                 <div class="bottom-info">
                  <span style="color: goldenrod;">Today</span>
                  <span> • ${c.todayCases} cases • ${c.todayDeaths} deaths</span>
                  <span style="color:gray">Last updated on: ${new Date(c.updated).toLocaleString()} </span>
                 </div>
              </div>
            </div>
          `
